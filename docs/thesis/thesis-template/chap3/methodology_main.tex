...
$(\Delta\eta,\Delta\phi)$. The seven-dimensional feature vector
$(p_T,\eta,\phi,E,\Delta\eta,\Delta\phi,\log p_T)$ is standardised
feature-wise using statistics computed on the training split only.
