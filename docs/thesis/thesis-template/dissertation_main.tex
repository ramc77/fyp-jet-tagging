...
\chairperson{Dr.\ [Chairperson, Dept.\ of Natural Sciences]}
\dean{Prof.\ Dr.\ [Dean of Faculty]}
...
\begin{document}
	...
	\input{frontmatter/01_TitlePage}              % formal title page
	\input{frontmatter/0Declaration}               % declaration of originality
	\input{frontmatter/0Certificate}               % supervisor certificate
	\input{frontmatter/dedication}                 % dedication (optional)
	\input{frontmatter/acknowledgements}           % acknowledgements
	\input{frontmatter/abstract}                   % abstract (max 250 words)
	...
	\input{frontmatter/abbreviations}              % list of abbreviations
	\if@openright\cleardoublepage\else\clearpage\fi
	...
	\input{chap1/introduction_main}                % Chapter 1: Introduction
	\input{chap2/literature_review_main}           % Chapter 2: Literature Review
	\input{chap3/methodology_main}                 % Chapter 3: Methodology
	\input{chap4/results_main}                     % Chapter 4: Results and Discussion
	\input{chap5/conclusions_main}                 % Chapter 5: Conclusions
	...
	%% ============================================================
	\appendix
	\input{appA/appendix_a_main}                   % Appendix A
